...
import DeleteSemesterDialog from '~/components/dashboard/DeleteSemesterDialog.vue' // 1. Import komponen
...
// State khusus untuk Delete Modal
...
function handleRowClick(workspace: Workspace) {
  router.push(`/workspace/${workspace.name.toLowerCase().replace(/\s+/g, '-')}`)
}
